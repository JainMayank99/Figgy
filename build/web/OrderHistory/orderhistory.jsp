                                            ...
                                            <div>
                                                ...
                                                <%   
                                                    while (rs.next()) {
                                                        ...
                                                        total = quan * price;
                                                        str2 = "Select distinct f.Food_name,f.Price,o.Quantity from resturant as r, food as f ,order_history as o where f.Food_ID=o.Food_ID and Customer_ID=? and o.DateTime=' "+odt+"'";
